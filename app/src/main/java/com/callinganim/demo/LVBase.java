...
public abstract class LVBase extends View {
    ...
    protected EndCallbackListener mCallbackListener;
    ...
    public void startAnim() {
        stopAnim();
        startViewAnim(0f, 1f, 500/20);
    }

    public void startAnim(int time) {
        stopAnim();
        startViewAnim(0f, 1f, time/20);
    }

    public abstract void setEndCallbackListener(EndCallbackListener mCallbackListener);
